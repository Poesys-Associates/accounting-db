...
/**
 * <p>
 * A test class for the CapitalAccountDelegate class. This class is the concrete
 ...
 */
public class CapitalAccountDelegateTest extends
    com.poesys.accounting.bs.account.AbstractCapitalAccountDelegateTest {
  ...
  @Override
  protected List<BsCapitalAccount> createAccountCapitalAccount(int count)
      throws DelegateException, InvalidParametersException {
    List<BsCapitalAccount> objects = new ArrayList<BsCapitalAccount>();
    Random r = new Random();
  ...
  public void testUpdate() {
    ...
    List<BsCapitalAccount> objects = null;
    ...
    try {
      ...
      objects = createAccountCapitalAccount(1);
      ...
      BsCapitalAccount updateAccount = objects.get(0);
      ...
      // Verify the update.
      assertTrue("CapitalAccount not updated",
  ...
  public void testUpdateBatch() throws InvalidParametersException,
    ...
    try {
      connection =
        JdbcConnectionManager.getConnection(DBMS.MYSQL, getSubsystem());
      objects = createAccountCapitalAccount(2);
      delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
      DelegateException {
    Connection connection = null;
    List<BsCapitalAccount> allObjects = null;
    ...
    try {
      ...
      allObjects = createAccountCapitalAccount(3);

      // Insert the first two rows.
      List<BsCapitalAccount> existingObjects =
        new ArrayList<BsCapitalAccount>();
      ...
      BsCapitalAccount updateAccount = existingObjects.get(0);
      String originalDescription = updateAccount.getDescription();
      updateAccount.setDescription(StringUtilities.generateString(100));

      // Delete the second object in the array.
      BsCapitalAccount deletedAccount = existingObjects.get(1);
      deletedAccount.delete();

      // Track the inserted object (third in the array).
      BsCapitalAccount insertedAccount = allObjects.get(2);
      ...
      // Verify the delete.
      assertTrue("CapitalAccount not deleted",
  ...
  /**
   * Verify the insertion of a CapitalAccount.
   * 
  ...
  public boolean verifyInsert(Connection connection, String entityName,
    ...
    try {
      ...
      if (rs.next()) {
        ...
        fail("No CapitalAccount created for update");
      }
    } catch (SQLException e) {
  ...
  /**
   * Verify the updated description for a CapitalAccount.
   * 
   * @param connection the JDBC connection
   * @param entityName the entity containing the account
   * @param accountName the name of the account
  ...
  /**
   * Verify the deletion of a CapitalAccount.
   * 
   * @param connection the JDBC connection
   * @param entityName the entity containing the account
   * @param accountName the name of the account
