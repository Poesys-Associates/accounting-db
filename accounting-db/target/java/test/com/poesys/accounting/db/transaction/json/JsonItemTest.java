...
public class JsonItemTest {
  ...
  private static final String TRANSACTION1 = "100";
  private static final String TRANSACTION2 = "200";
  ...
  public void testRegularItem() {
    ...
    JsonItem item =
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, CHECKING, null, null,
                   null, null);
    ...
    assertTrue("invalid JSON string from item: " + json, json.equals(
      "{\"transactionId\":\"100\",\"orderNumber\":1,\"amount\":10.0,\"debit\":true," +
      "\"checked\":false,\"accountKey\":{\"keyType\":\"com.poesys.db.pk.CompositePrimaryKey\"," +
      "\"className\":\"com.poesys.accounting.db.account.Account\",\"columnValueList\":null," +
      "\"value\":null,\"keyList\":null,\"parentKey\":{\"keyType\":\"com.poesys.db.pk" +
      ".NaturalPrimaryKey\",\"className\":\"com.poesys.accounting.db.account.Entity\"," +
  ...
  public void testReceivableItem() {
    ...
    List<JsonPrimaryKey> receivableKeys = getItemPrimaryKeys("100", ORDER.toString());
    List<JsonPrimaryKey> reimbursingItemKeys = getItemPrimaryKeys("200", ORDER.toString());
    JsonPrimaryKey receivableKey = receivableKeys.get(0);
    JsonPrimaryKey reimbursingItemKey = reimbursingItemKeys.get(0);

    List<JsonReimbursement> reimbursements = getReimbursements(receivableKey, reimbursingItemKey);

    JsonItem item =
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, RECEIVABLE, null, null,
                   reimbursingItemKeys, reimbursements);
    // Create the Gson object.
    Gson gson = new GsonBuilder().serializeNulls().create();
    // Produce the JSON string.
    String json = gson.toJson(item, JsonItem.class);
  ...
  public void testReimbursingItem() {
    ...
    JsonItem item = new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, RECEIVABLE,
   ...
   *
   * @param transactionId the String BigInteger for the transaction identifier
   * @param orderNumber   the String integer for the order number
   * @return a list of JSON primary keys with a single item key containing the transaction id and
   * order number
   */
  private List<JsonPrimaryKey> getItemPrimaryKeys(String transactionId, String orderNumber) {
   ...
   *
   * @param receivableKey      the JSON primary key for the receivable item
   * @param reimbursingItemKey the JSON primary key for the reimbursing item
   ...
   */
  private List<JsonReimbursement> getReimbursements(JsonPrimaryKey receivableKey, JsonPrimaryKey
    reimbursingItemKey) {
    // Build the JSON reimbursement.
    JsonReimbursement reimbursement =
      new JsonReimbursement(receivableKey, reimbursingItemKey, REIMBURSED_AMOUNT, ALLOCATED_AMOUNT);
   ...
   */
  @Test
  public void testNullRequiredInputOrder() {
    try {
      new JsonItem(TRANSACTION1, null, AMOUNT, true, false, ACCOUNT_KEY, RECEIVABLE,
                   null, null, null, null);
      fail("no exception thrown for missing order number");
  ...
  public void testNullRequiredInputAmount() {
    try {
      new JsonItem(TRANSACTION1, ORDER, null, true, false, ACCOUNT_KEY, RECEIVABLE, null, null,
                   null, null);
  ...
  public void testNullRequiredInputAccountKey() {
    try {
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, null, RECEIVABLE, null, null, null,
                   null);
  ...
  public void testNullRequiredInputAccountName() {
    try {
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, null, null, null, null,
                   null);
  ...
  public void testDefaultDebit() {
    ...
    ACCOUNT_KEY_NAME_LIST.add(CHECKING_COLUMN_VALUE);
    JsonItem item =
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, null, false, ACCOUNT_KEY, CHECKING, null, null,
                   null, null);
  ...
  public void testDefaultChecked() {
    ...
    ACCOUNT_KEY_NAME_LIST.add(CHECKING_COLUMN_VALUE);
    JsonItem item =
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, null, ACCOUNT_KEY, CHECKING, null, null, null,
                   null);
  ...
  public void testNotEqualsTransactionId() {
    ...
    JsonItem item1 =
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, CHECKING, null, null,
                   null, null);
    JsonItem item2 =
      new JsonItem(TRANSACTION2, ORDER, AMOUNT, true, false, ACCOUNT_KEY, RECEIVABLE, null, null,
                   null, null);
  ...
  public void testNotEqualsOrderNumber() {
    ...
    JsonItem item1 =
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, CHECKING, null, null,
                   null, null);
    JsonItem item2 =
      new JsonItem(TRANSACTION1, ORDER2, AMOUNT, true, false, ACCOUNT_KEY, CHECKING, null, null,
                   null, null);
  ...
  public void testHashcode() {
    ...
    List<JsonPrimaryKey> receivableKeys = getItemPrimaryKeys(TRANSACTION1, ORDER.toString());
    JsonPrimaryKey receivableKey = receivableKeys.get(0);
    List<JsonPrimaryKey> reimbursingItemKeys = getItemPrimaryKeys(TRANSACTION2, ORDER.toString());
    JsonPrimaryKey reimbursingItemKey = reimbursingItemKeys.get(0);
    ...
    JsonItem item = new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, RECEIVABLE,
                                 receivableKeys, reimbursements, null, null);
    assertTrue("wrong hash code: " + item.hashCode(), item.hashCode() == 1463054032);
  }
  ...
  public void testDifferentObjectHashcodes() {
    ...
    ACCOUNT_KEY_NAME_LIST.add(CHECKING_COLUMN_VALUE);
    JsonItem item =
      new JsonItem(TRANSACTION1, ORDER, AMOUNT, true, false, ACCOUNT_KEY, CHECKING, null, null, null, null);
    JsonItem item2 =
      new JsonItem(TRANSACTION2, ORDER2, AMOUNT, true, false, ACCOUNT_KEY, CHECKING, null, null, null, null);
