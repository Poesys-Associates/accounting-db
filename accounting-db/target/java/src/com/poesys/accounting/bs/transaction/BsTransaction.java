...
/**
 * <p>
 * A business layer data-transfer object for the Transaction. This class
 ...
 */
public class BsTransaction extends com.poesys.accounting.bs.transaction.AbstractBsTransaction {
   ...
   */
  public BsTransaction(com.poesys.accounting.db.transaction.ITransaction dto) throws DelegateException {
    super(dto);
  }
...
transactions
   */
  public BsTransaction(IPrimaryKey key, java.math.BigInteger transactionId, java.lang.String description, java.sql.Timestamp transactionDate, java.lang.Boolean checked, java.lang.Boolean balance) {
