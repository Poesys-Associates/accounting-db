...
/**
 * <p>
 * A business layer data-transfer object (DTO) for the SimpleAccount. This class
 ...
 */
public abstract class AbstractBsSimpleAccount 
    extends AbstractDto<com.poesys.accounting.db.account.ISimpleAccount> {
   ...
   */
  public AbstractBsSimpleAccount(ISimpleAccount dto) throws DelegateException {
    super(dto);
  }

  /**
   * Create a SimpleAccount from new data.
   *
...
debt owed to the accounting entity
   */
  public AbstractBsSimpleAccount(IPrimaryKey key, java.lang.String accountName, java.lang.String entityName, java.lang.String description, java.lang.Boolean debitDefault, java.lang.Boolean active, java.lang.Boolean receivable) {
    super(new SimpleAccountProxy(new SimpleAccount(key, accountName, entityName, description, debitDefault, active, receivable)));
  }
  ...
  public boolean equals(Object arg0) {
    // Unchecked cast here
    IDto<ISimpleAccount> other = (IDto<ISimpleAccount>)arg0;
  ...
  public int compareTo(IDto<ISimpleAccount> o) {
...
// Read/Write property: true
   ...
   * <ul>
   * <li>Property is read/write: true</li>
   * <li>Property is defined in the data-access object SimpleAccount</li>
   * </ul>
