...
import com.poesys.accounting.db.account.DistributionAccountProxy;
import com.poesys.accounting.db.account.DistributionAccount;


/**
 * <p>
 * A business layer data-transfer object (DTO) for the DistributionAccount. This class
 ...
 */
public abstract class AbstractBsDistributionAccount 
    extends AbstractDto<com.poesys.accounting.db.account.IDistributionAccount> {
   ...
   */
  public AbstractBsDistributionAccount(IDistributionAccount dto) throws DelegateException {
    super(dto);
  }

  /**
   * Create a DistributionAccount from new data.
   *
...
in reports where referenced by items
   ...
   */
  public AbstractBsDistributionAccount(IPrimaryKey key, java.lang.String accountName, java.lang.String entityName, java.lang.String description, java.lang.Boolean debitDefault, java.lang.Boolean active, java.lang.String capitalEntityName) {
    super(new DistributionAccountProxy(new DistributionAccount(key, accountName, entityName, description, debitDefault, active, capitalEntityName)));
  }
  ...
  public boolean equals(Object arg0) {
    // Unchecked cast here
    IDto<IDistributionAccount> other = (IDto<IDistributionAccount>)arg0;
  ...
  public int compareTo(IDto<IDistributionAccount> o) {
...
// Read/Write property: true
   ...
   * <ul>
   * <li>Property is read/write: true</li>
   * <li>Property is defined in the data-access object DistributionAccount</li>
   * </ul>
