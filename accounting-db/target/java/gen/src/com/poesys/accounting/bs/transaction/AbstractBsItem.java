...
/**
 * <p>
 * A business layer data-transfer object (DTO) for the Item. This class
 ...
 */
public abstract class AbstractBsItem 
    extends AbstractDto<com.poesys.accounting.db.transaction.IItem> {
  ...
  private class BsReimbursingItemsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.accounting.db.transaction.IItem, com.poesys.accounting.bs.transaction.BsItem> {
    @Override
   ...
   * of Item objects from an input Collection reimbursingItems of 
   * business-layer BsItem objects
   */
  private class ReimbursingItemsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.accounting.bs.transaction.BsItem, com.poesys.accounting.db.transaction.IItem> {
    @Override
  ...
  /**
   * A Collection builder helper class for building a data-access-layer Collection 
   * of Item objects from an input Collection receivables of 
   * business-layer BsItem objects
   */
  ...
  /**
   * A Collection builder helper class for building a business-layer Collection 
   * of BsReimbursement objects from a Collection reimbursingItemsReimbursement of data-access-layer 
   * com.poesys.accounting.db.transaction.IReimbursement objects
   */
  private class BsReimbursingItemsReimbursementCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.accounting.db.transaction.IReimbursement, com.poesys.accounting.bs.transaction.BsReimbursement> {
    @Override
  ...
  /**
   * A Collection builder helper class for building a data-access-layer Collection 
   * of Reimbursement objects from an input Collection reimbursingItemsReimbursement of 
   * business-layer BsReimbursement objects
   */
  private class ReimbursingItemsReimbursementCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.accounting.bs.transaction.BsReimbursement, com.poesys.accounting.db.transaction.IReimbursement> {
    @Override
  ...
  /**
   * A Collection builder helper class for building a business-layer Collection 
   * of BsReimbursement objects from a Collection receivablesReimbursement of data-access-layer 
   * com.poesys.accounting.db.transaction.IReimbursement objects
   */
  private class BsReceivablesReimbursementCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.accounting.db.transaction.IReimbursement, com.poesys.accounting.bs.transaction.BsReimbursement> {
    @Override
    public com.poesys.accounting.bs.transaction.BsReimbursement get(com.poesys.accounting.db.transaction.IReimbursement dto) {
      return new com.poesys.accounting.bs.transaction.BsReimbursement(dto);
  ...
  /**
   * A Collection builder helper class for building a data-access-layer Collection 
   * of Reimbursement objects from an input Collection receivablesReimbursement of 
   * business-layer BsReimbursement objects
   */
  private class ReceivablesReimbursementCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.accounting.bs.transaction.BsReimbursement, com.poesys.accounting.db.transaction.IReimbursement> {
    @Override
    public com.poesys.accounting.db.transaction.IReimbursement get(com.poesys.accounting.bs.transaction.BsReimbursement dto) {
      return dto.toDto();
...
reconciled
   ...
   */
  public AbstractBsItem(IPrimaryKey key, java.math.BigInteger transactionId, java.lang.Integer orderNumber, java.lang.Double amount, java.lang.Boolean debit, java.lang.Boolean checked, java.lang.String accountName, java.lang.String entityName) {
    super(new ItemProxy(new Item(key, transactionId, orderNumber, amount, debit, checked, accountName, entityName)));
  }
   ...
   */
  public java.util.Collection<com.poesys.accounting.bs.transaction.BsItem> getReimbursingItems() throws java.sql.SQLException {
    BsReimbursingItemsCollectionBuilder builder = new BsReimbursingItemsCollectionBuilder();
   ...
   *                 the data-access status to CHANGED
   */
  public void setReimbursingItem(java.util.Collection<com.poesys.accounting.bs.transaction.BsItem> entityName) 
      throws com.poesys.db.dto.DtoStatusException{
    ReimbursingItemsCollectionBuilder builder = new ReimbursingItemsCollectionBuilder();
      dto.setReimbursingItem(builder.getCollection(entityName));
  }
   ...
   *                               load the property lazily
   */
  public java.util.Collection<com.poesys.accounting.bs.transaction.BsItem> getReceivables() throws java.sql.SQLException {
    BsReceivablesCollectionBuilder builder = new BsReceivablesCollectionBuilder();
   ...
   *                 the data-access status to CHANGED
   */
  public void setReceivable(java.util.Collection<com.poesys.accounting.bs.transaction.BsItem> entityName) 
      throws com.poesys.db.dto.DtoStatusException{
    ReceivablesCollectionBuilder builder = new ReceivablesCollectionBuilder();
      dto.setReceivable(builder.getCollection(entityName));
  }
   ...
   * <li>Property is defined in the data-access object Item</li>
   * </ul>
   * @return a com.poesys.accounting.bs.transaction.BsReimbursement entityName
   * @throws java.sql.SQLException when the method can't get a SQL connection to 
   *                               load the property lazily
   */
  public java.util.Collection<com.poesys.accounting.bs.transaction.BsReimbursement> getReimbursingItemsReimbursement() throws java.sql.SQLException {
    BsReimbursingItemsReimbursementCollectionBuilder builder = new BsReimbursingItemsReimbursementCollectionBuilder();
    return builder.getCollection(dto.getReimbursingItemsReimbursement());
  }
   ...
   */
  public void setReimbursingItemsReimbursement(java.util.Collection<com.poesys.accounting.bs.transaction.BsReimbursement> entityName) 
      throws com.poesys.db.dto.DtoStatusException, com.poesys.db.InvalidParametersException {
    ReimbursingItemsReimbursementCollectionBuilder builder = new ReimbursingItemsReimbursementCollectionBuilder();
      dto.setReimbursingItemsReimbursement(builder.getCollection(entityName));
  }
   ...
   *                               load the property lazily
   */
  public java.util.Collection<com.poesys.accounting.bs.transaction.BsReimbursement> getReceivablesReimbursement() throws java.sql.SQLException {
    BsReceivablesReimbursementCollectionBuilder builder = new BsReceivablesReimbursementCollectionBuilder();
    return builder.getCollection(dto.getReceivablesReimbursement());
  }
   ...
   *                 required but the input parameter entityName is null
   */
  public void setReceivablesReimbursement(java.util.Collection<com.poesys.accounting.bs.transaction.BsReimbursement> entityName) 
      throws com.poesys.db.dto.DtoStatusException, com.poesys.db.InvalidParametersException {
    ReceivablesReimbursementCollectionBuilder builder = new ReceivablesReimbursementCollectionBuilder();
      dto.setReceivablesReimbursement(builder.getCollection(entityName));
  }
   ...
   *                               load the property lazily
   */
  public void addReimbursingItemsItem(com.poesys.accounting.bs.transaction.BsItem object) throws java.sql.SQLException {
    if (object == null) {
      throw new com.poesys.db.InvalidParametersException(com.poesys.db.Message.getMessage("com.poesys.db.dao.msg.no_dto", null));
    }
    
    dto.addReimbursingItemsItem(object.toDto());
  }
   ...
   *                               load the property lazily
   */
  public void addReceivablesItem(com.poesys.accounting.bs.transaction.BsItem object) throws java.sql.SQLException {
    if (object == null) {
      throw new com.poesys.db.InvalidParametersException(com.poesys.db.Message.getMessage("com.poesys.db.dao.msg.no_dto", null));
    }
    
    dto.addReceivablesItem(object.toDto());
  }
   ...
   *                               load the property lazily
   */
  public void addReimbursingItemsReimbursementReimbursement(com.poesys.accounting.bs.transaction.BsReimbursement object) throws java.sql.SQLException {
    if (object == null) {
      throw new com.poesys.db.InvalidParametersException(com.poesys.db.Message.getMessage("com.poesys.db.dao.msg.no_dto", null));
    }
    
    dto.addReimbursingItemsReimbursementReimbursement(object.toDto());
  }
   ...
   *                               load the property lazily
   */
  public void addReceivablesReimbursementReimbursement(com.poesys.accounting.bs.transaction.BsReimbursement object) throws java.sql.SQLException {
    if (object == null) {
      throw new com.poesys.db.InvalidParametersException(com.poesys.db.Message.getMessage("com.poesys.db.dao.msg.no_dto", null));
    }
    
    dto.addReceivablesReimbursementReimbursement(object.toDto());
  }
}