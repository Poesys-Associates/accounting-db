 ...
 * Item object through the association Receivables using the 
 ...
 */
public abstract class AbstractQueryReceivablesByItem 
  ...
  private static final String SQL =
    "SELECT a.transactionId, a.orderNumber, a.amount, a.debit, a.checked, a.accountName, a.entityName FROM Item a JOIN Reimbursement b ON a.orderNumber = b.receivablesOrderNumber AND a.transactionId = b.receivablesTransactionId WHERE b.reimbursingItemsOrderNumber = ? AND b.reimbursingItemsTransactionId = ?";
