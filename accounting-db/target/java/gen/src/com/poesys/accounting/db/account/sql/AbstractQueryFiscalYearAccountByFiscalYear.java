 ...
 * class FiscalYear. These objects are the linking objects from the SQL 
 * table FiscalYearAccount rather than the objects associated through
 * the link (Account), which have a separate representation.
 * </p>
 * 
 * @author Poesys/DB Cartridge
 */
public abstract class AbstractQueryFiscalYearAccountByFiscalYear 
    implements IParameterizedQuerySql<com.poesys.accounting.db.account.IFiscalYearAccount, com.poesys.accounting.db.account.IFiscalYear> {
  /** SQL query statement for FiscalYearAccount */
  private static final String SQL =
    "SELECT accountName, entityName, year, accountOrderNumber, groupOrderNumber, accountType, groupName FROM FiscalYearAccount WHERE year = ?";
