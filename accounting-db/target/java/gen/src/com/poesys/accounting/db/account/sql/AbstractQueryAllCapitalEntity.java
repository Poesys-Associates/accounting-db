 ...
 * CapitalEntity objects in the database; use with caution
 * </p>
 * 
 * @author Poesys/DB Cartridge
 */
public abstract class AbstractQueryAllCapitalEntity implements IQuerySql<com.poesys.accounting.db.account.ICapitalEntity> {
  private static final Logger logger = Logger.getLogger(AbstractQueryAllCapitalEntity.class);
  /** SQL query statement for CapitalEntity */
  private static final String SQL =
    "SELECT capitalEntityName FROM CapitalEntity";

  @Override
  public com.poesys.accounting.db.account.ICapitalEntity getData(ResultSet rs) {
    try {
      IPrimaryKey key = 
        AccountFactory.getCapitalEntityPrimaryKey(rs, "");
      
      return AccountFactory.getCapitalEntityData(key, rs);
  ...
  public IPrimaryKey getPrimaryKey(ResultSet rs) throws InvalidParametersException {
    try {
      return AccountFactory.getCapitalEntityPrimaryKey(rs, "");
