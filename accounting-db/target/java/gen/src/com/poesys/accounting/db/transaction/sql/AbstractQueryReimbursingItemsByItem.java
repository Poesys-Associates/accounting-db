 ...
 * Item object through the association ReimbursingItems using the 
 ...
 */
public abstract class AbstractQueryReimbursingItemsByItem 
  ...
  private static final String SQL =
    "SELECT a.transactionId, a.orderNumber, a.amount, a.debit, a.checked, a.accountName, a.entityName FROM Item a JOIN Reimbursement b ON a.orderNumber = b.reimbursingItemsOrderNumber AND a.transactionId = b.reimbursingItemsTransactionId WHERE b.receivablesOrderNumber = ? AND b.receivablesTransactionId = ?";
