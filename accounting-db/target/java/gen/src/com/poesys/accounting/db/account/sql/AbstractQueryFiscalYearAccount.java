 ...
 * FiscalYearAccount. This SQL specification contains a SQL statement that queries
 * a single FiscalYearAccount object from the database using the primary key.
 * </p>
 * 
 * @author Poesys/DB Cartridge
 */
public abstract class AbstractQueryFiscalYearAccount implements IKeyQuerySql<com.poesys.accounting.db.account.IFiscalYearAccount> {
  ...
  private static final String SQL =
    "SELECT accountName, entityName, year, accountOrderNumber, groupOrderNumber, accountType, groupName FROM FiscalYearAccount WHERE ";

  public com.poesys.accounting.db.account.IFiscalYearAccount getData(IPrimaryKey key, ResultSet rs) {
    try {
    return com.poesys.accounting.db.account.AccountFactory.getFiscalYearAccountData(key, rs);
