 ...
 */
public abstract class AbstractCapitalAccount extends com.poesys.accounting.db.account.Account implements ICapitalAccount {
  /** Default serial version UID for the Serializable DTO */
  private static final long serialVersionUID = 1L;

  /** Logger for this class */
  private static final Logger logger = Logger.getLogger(AbstractCapitalAccount.class);

  /** the deserializer used by the readObject method */
  private static final com.poesys.db.dto.Deserializer<AbstractCapitalAccount> deserializer =
    new com.poesys.db.dto.Deserializer<AbstractCapitalAccount>();
  ...
  /**
   * Create an empty CapitalAccount for use in building a new object. The 
  ...
  /**
   * Create a CapitalAccount. The concrete subclass must call this constructor.
   *
...
in reports where referenced by items
   ...
   */
  public AbstractCapitalAccount(IPrimaryKey key, java.lang.String accountName, java.lang.String entityName, java.lang.String description, java.lang.Boolean debitDefault, java.lang.Boolean active, java.lang.Double ownership, java.lang.String capitalEntityName) {
    super(key, entityName, accountName, description, debitDefault, active);

    this.ownership = ownership;

    if (ownership == null) {
      throw new com.poesys.db.InvalidParametersException("ownership is required for " + key.getValueList());
    }
   ...
   */
  private java.lang.Double ownership;
  ...
  /**
   * Clear the ownership data member; override in proxy if lazily loaded,
   ...
   * </p>
   *
   * @param ownership the value with which to set the property
   */
  public void setOwnership(java.lang.Double ownership)
      throws com.poesys.db.InvalidParametersException {
    if (ownership == null) {
      throw new com.poesys.db.InvalidParametersException("ownership is required");
    }
  ...
  private void createInserters() {
    ...
    com.poesys.db.dao.insert.IInsert<ICapitalAccount> inserter =
      capitalAccountFactory.getInsert(sql, true);
