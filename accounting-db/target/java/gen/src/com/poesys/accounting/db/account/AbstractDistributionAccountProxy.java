 ...
 * DistributionAccount. This class is an abstract class that contains AndroMDA 
 ...
 */
public abstract class AbstractDistributionAccountProxy extends AbstractLazyLoadingDtoProxy implements IDistributionAccount {
  /** Default serial version UID for the Serializable DTO */
  private static final long serialVersionUID = 1L;

  /** Logger for this class */
  private static final Logger logger = Logger.getLogger(AbstractDistributionAccountProxy.class);

  /** the deserializer used by the readObject method */
  private static final com.poesys.db.dto.Deserializer<AbstractDistributionAccountProxy> deserializer =
    new com.poesys.db.dto.Deserializer<AbstractDistributionAccountProxy>();
  ...
  private class QueryCapitalEntitySetter 
    ...
    protected com.poesys.db.pk.IPrimaryKey getKey() {
      ...
      // from the com.poesys.accounting.db.account.IDistributionAccount object
      return com.poesys.accounting.db.account.AccountFactory.getCapitalEntityPrimaryKey(((IDistributionAccount)dto).getCapitalEntityName());
    }
    ...
    public boolean isSet() {
      ...
      return (((DistributionAccount)dto).getCapitalEntity() != null);
    }
  }

  /**
   * Create a DistributionAccountProxy. The concrete subclass must call this constructor.
   *
   * @param dto the DTO to proxy
   */
  public AbstractDistributionAccountProxy(DistributionAccount dto) {
    super(dto);
  ...
  private void readObject(java.io.ObjectInputStream in) throws java.io.IOException,
    ...
    logger.debug("Deserializing object of class " + this.getClass().getName()
                 + " with readObject in AbstractDistributionAccountProxy");
  ...
  public boolean equals(Object obj) {
    AbstractDistributionAccountProxy otherProxy = (AbstractDistributionAccountProxy)obj;
    return ((DistributionAccount)dto).equals(otherProxy.dto);
  }

  @Override
  public int hashCode() {
    return ((DistributionAccount)dto).hashCode();
  }
  // Inherited properties

  public java.lang.String getAccountName() {
    return ((IDistributionAccount)dto).getAccountName();
  }

  public java.lang.String getEntityName() {
    return ((IDistributionAccount)dto).getEntityName();
  }

  public com.poesys.accounting.db.account.IEntity getEntity() {
    return ((IDistributionAccount)dto).getEntity();
  }
  ...
  public void setEntity(com.poesys.accounting.db.account.IEntity entity)
    ...
    ((DistributionAccount)dto).setEntity(entity);
  }
  ...
  private class QueryYearsSetter 
    ...
    @Override
    protected IDistributionAccount getParametersDto() {
      return AbstractDistributionAccountProxy.this;
    }
    ...
    protected void set(java.util.Collection<com.poesys.accounting.db.account.IFiscalYear> collection) {
      try {
        ...
        for (com.poesys.accounting.db.account.IFiscalYear child : collection) {
          child.attach(AbstractDistributionAccountProxy.this.dto,
  ...
  public void addYearsFiscalYear(com.poesys.accounting.db.account.IFiscalYear object) {
    ...
    ((DistributionAccount)dto).addYearsFiscalYear(object);
  }
  ...
  public java.util.Collection<com.poesys.accounting.db.account.IFiscalYear> getYears() {
    // Lazy-load the inherited years from the DistributionAccount 
    // if not loaded and the inherited key is not null.
    if (!yearsLoaded && ((IDistributionAccount)dto).getAccountName() != null && ((IDistributionAccount)dto).getEntityName() != null) {
      com.poesys.db.dto.ISet setter = new QueryYearsSetter();
      setter.set();
      // Mark the field as loaded once the query setter has run.
      yearsLoaded = true;
    }
    return ((IDistributionAccount)dto).getYears();
  }
  ...
  public void clearYears() {
    ...
    if (yearsLoaded) {
      try {
        ...
        ((DistributionAccount)dto).setFiscalYear(null);
        ((DistributionAccount)dto).undoStatus();
        yearsLoaded = false;
      } catch (com.poesys.db.dto.DtoStatusException e) {
  ...
  public void setFiscalYear(java.util.Collection<com.poesys.accounting.db.account.IFiscalYear> years)
      {
    ((DistributionAccount)dto).setFiscalYear(years);
  ...
  public java.util.List<com.poesys.accounting.db.transaction.IItem> getItems() {
    return ((IDistributionAccount)dto).getItems();
  }
  ...
  public void setItems(java.util.List<com.poesys.accounting.db.transaction.IItem> items)
      {
    ((DistributionAccount)dto).setItems(items);
  }
// Adding add method here
  ...
  public void addItemsItem(com.poesys.accounting.db.transaction.IItem object) {
    ((DistributionAccount)dto).addItemsItem(object);
  }
  ...
  public void addFiscalYearAccountFiscalYearAccount(com.poesys.accounting.db.account.IFiscalYearAccount object) {
    ...
    ((DistributionAccount)dto).addFiscalYearAccountFiscalYearAccount(object);
  }
  ...
  public java.util.Collection<com.poesys.accounting.db.account.IFiscalYearAccount> getFiscalYearAccount() {
    // Lazy-load the inherited fiscalYearAccount from the DistributionAccount 
    // if not loaded and the inherited key is not null.
    if (!fiscalYearAccountLoaded && ((IDistributionAccount)dto).getAccountName() != null && ((IDistributionAccount)dto).getEntityName() != null) {
      com.poesys.db.dto.ISet setter = new QueryFiscalYearAccountSetter();
      setter.set();
      // Mark the field as loaded once the query setter has run.
      fiscalYearAccountLoaded = true;
    }
    return ((IDistributionAccount)dto).getFiscalYearAccount();
  }
  ...
  public void clearFiscalYearAccount() {
    ...
    if (fiscalYearAccountLoaded) {
      try {
        // Call the local lazy property setter to clear the property.
        ((DistributionAccount)dto).setFiscalYearAccount(null);
        ((DistributionAccount)dto).undoStatus();
  ...
  public void setFiscalYearAccount(java.util.Collection<com.poesys.accounting.db.account.IFiscalYearAccount> fiscalYearAccount)
      throws com.poesys.db.InvalidParametersException {
    ((DistributionAccount)dto).setFiscalYearAccount(fiscalYearAccount);
  ...
  public java.lang.String getDescription() {
    return ((IDistributionAccount)dto).getDescription();
  }
  ...
  public void setDescription(java.lang.String description)
      throws com.poesys.db.InvalidParametersException {
    ((DistributionAccount)dto).setDescription(description);
  }

  public java.lang.Boolean getDebitDefault() {
    return ((IDistributionAccount)dto).getDebitDefault();
  }
  ...
  public void setDebitDefault(java.lang.Boolean debitDefault)
      throws com.poesys.db.InvalidParametersException {
    ((DistributionAccount)dto).setDebitDefault(debitDefault);
  }

  public java.lang.Boolean getActive() {
    return ((IDistributionAccount)dto).getActive();
  }
  ...
  public void setActive(java.lang.Boolean active)
      throws com.poesys.db.InvalidParametersException {
    ((DistributionAccount)dto).setActive(active);
  }
  ...
  public com.poesys.accounting.db.account.ICapitalEntity getCapitalEntity() {
    return ((DistributionAccount)dto).getCapitalEntity();
  }
  ...
  public void setCapitalEntity(com.poesys.accounting.db.account.ICapitalEntity capitalEntity)
      throws com.poesys.db.InvalidParametersException {
    ((DistributionAccount)dto).setCapitalEntity(capitalEntity);
  }
  ...
  public java.lang.String getCapitalEntityName() {
    return ((DistributionAccount)dto).getCapitalEntityName();
  }
  ...
  void setCapitalEntityName(java.lang.String capitalEntityName)
      throws com.poesys.db.InvalidParametersException {
    ((DistributionAccount)dto).setCapitalEntityName(capitalEntityName);
  }

  public void markChildrenDeleted() {
  	((DistributionAccount)dto).markChildrenDeleted();
  }
}