...
// Read/Write property: true
   ...
   * @throws com.poesys.db.dto.DtoStatusException when the status cannot be set to CHANGED
   */
  public void setTransactionDate(java.sql.Timestamp transactionDate) throws com.poesys.db.InvalidParametersException;
...
// Read/Write property: true
   ...
   * @throws com.poesys.db.dto.DtoStatusException when the status cannot be set to CHANGED
   */
  public void setBalance(java.lang.Boolean balance) throws com.poesys.db.InvalidParametersException;
...
// Read/Write property: true
   ...
   * @throws com.poesys.db.dto.DtoStatusException when the status cannot be set to CHANGED
   */
  public void setItems(java.util.List<com.poesys.accounting.db.transaction.IItem> items) throws com.poesys.db.InvalidParametersException;
