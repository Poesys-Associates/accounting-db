...
public abstract class AbstractAccountTypeDelegateTest {
  ...
  protected static Logger logger = Logger.getLogger(AbstractAccountTypeDelegateTest.class);
  ...
  protected void clearCaches() {
    ...
    IDaoManager AccountGroupManager = DaoManagerFactory.getManager("com.poesys.accounting.db.account");
   ...
   * </p>
   * <ul>
   * <li>Create the list to return as a CopyOnWriteArrayList&lt;BsAccountGroup&gt;</li>
   ...
   * @return true if the column is updated, false if not
   */
  protected boolean isColumnUpdated(BsAccountType original, BsAccountType queried) {
    boolean retVal = true;
    return retVal;
  }
  ...
  /**
   * Test the creation and adding of a child BsAccountGroup object to the BsAccountType
   * as a groups link.
   */
  @Test
  public void testUpdateAddGroupsAccountGroup()  {
    ...
    List<BsAccountGroup> children = createAccountAccountGroup(queriedObject.toDto(), 1);
  ...
  public void testTruncateTable() {
    delegate.truncateTable("AccountType");
    List<BsAccountType> objects = delegate.getAllObjects(100);
    assertTrue("Couldn't create list", objects != null);
